...
/**
 * This class builds upon the metric calculator and the stock analysis to recommend stock to the user based on input criteria
 * @author davidcasente
 *
 */
public class StockSearch {
	...
	/**
	 * creates the stock search class
	 * @param sector
	 * @param outlook
	 * @param priceMin
	 * @param priceMax
	...
	/**
	 * 
	 * @return the top three stocks we recommend in a particular sector
	 */
	 ...
	 * 
	 * @param name
	 * @return the stock score from stock analysis for a particular stock
	 */
	 ...
	 * 
	 * @param name
	 * @return the value for the recommendation column on the page
	 */
	 ...
	 * 
	 * @param name
	 * @return the net change of today for a particular stock
	 */
